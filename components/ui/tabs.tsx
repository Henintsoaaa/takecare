...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex space-x-2 h-10 items-center justify-center rounded-lg bg-purple-50 p-1 shadow-md h-full",
      className
    )}
    {...props}
  />
