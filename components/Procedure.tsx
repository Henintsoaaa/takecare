...
const Procedure = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg relative">
      <button
        onClick={handleBack}
        className="absolute top-4 left-4 text-indigo-600 hover:text-indigo-800 transition duration-300 pb-9"
      >
        <ArrowLeft className="h-6 w-6" />
      </button>
      <h1 className="text-3xl font-bold text-indigo-600 mb-4 pt-14">
      ...
      <ul className="list-disc list-inside space-y-4">
        <li className="p-4 border border-indigo-300 rounded-lg bg-gray-50">
          <strong className="text-indigo-600">Signalement immédiat :</strong> Il
          est important de porter plainte rapidement après l'incident de
          harcèlement.
        </li>
        <li className="p-4 border border-indigo-300 rounded-lg bg-gray-50">
        ...
        <li className="p-4 border border-indigo-300 rounded-lg bg-gray-50">
          <strong className="text-indigo-600">Précautions à prendre :</strong>{" "}
